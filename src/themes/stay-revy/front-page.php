<?php get_header(); ?>
    ...
    <main>
                            ...
                            <div class="item text-center h-100">
                                <div class="container hero-slide__container h-100">
                                    <div class="row justify-content-center align-items-center h-100">
                                        <div class="col-md-10">
                                            <h1 class="slider__title text-uppercase text-center mb-0">
                                                <span
        ...
        <!-- PingPong-->
        <?php if (have_rows('pingpongs_between_cards')): ?>
            <div class="container-fluid pt-3 pb-md-4">
                <?php while (have_rows('pingpongs_between_cards')) : the_row(); ?>
        ...
        <!-- PingPong-->
        <?php if (have_rows('pingpongs_above_footer')): ?>
            <div class="container-fluid pt-3 pb-md-4">
                <?php while (have_rows('pingpongs_above_footer')) : the_row(); ?>
                    <?php get_template_part('partials/frontpage/ping-pong'); ?>
                <?php endwhile; ?>
            </div>
        <?php endif; ?>
