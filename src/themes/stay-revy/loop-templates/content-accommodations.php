            ...
            <div class="row justify-content-between">
                <div class="col-12">
                    <div class="page-leftside listing-page-sidemenu py-1">
                        ...
                        <div class="collapse d-lg-block" id="hideShowFilters">
                            <form class="listing-page-sidemenu-form js-search-form px-1 pt-50">
                                <div class="listing-page-sidemenu-block mb-lg-0">
                                    <div class="increment-filters d-lg-flex justify-content-lg-around mb-lg-50">
                                        <div class="d-flex align-items-center js-num-increment">
                                            <label for="numberOfGuests"
                                                   class="listing-page-sidemenu__label mr-lg-50">Guests</label>
                                            ...
                                            </div><!-- num-increment-wrap -->
                                        </div><!-- flex -->
                                        <div class="d-flex align-items-center js-num-increment">
                                            <label for="numberOfBedrooms"
                                                   class="listing-page-sidemenu__label mr-lg-50">Bedrooms</label>
                                            <div class="num-increment-wrap">
                                        ...
                                        <div class="d-flex align-items-center js-num-increment">
                                            <label for="numberOfWashrooms" class="listing-page-sidemenu__label mr-lg-50">Washrooms</label>
                                            <div class="num-increment-wrap">
                                    ...
                                    <div class="d-lg-flex justify-content-lg-center">
                                        ...
                                        foreach ($categories as $category) { ?>
                                            ...
                                            <div class="custom-control custom-checkbox mb-250 mb-lg-0 mx-lg-50">
                                        ...
                                        <?php } ?>
                                        <div class="custom-control custom-checkbox mx-lg-50">
                                            <input
                                        ...
                                        <div class="custom-control custom-checkbox mb-1 mx-lg-50">
                                    ...
                                    <div class="form-cta-buttons text-center">
                                        <button class="btn btn-primary js-update-search d-block mb-75 px-1 mb-lg-0 mr-lg-50"
                                                type="submit">
                                            Update Search &nbsp;<i class="fas fa-search d-lg-none"></i>
                                        </button>
                                        <button href="<?php bloginfo('url'); ?>/vacation-rentals"
                                                class="btn btn-secondary d-block mb-0 px-1">
                                            Reset
                                        </button>
                                    </div><!-- text-center -->
                ...
                <div class="col-12">
                    <div class="page-rightside">
                        ...
                        <div class="js-view-list grid-listings" <?php echo($view == 'map' ? 'style="display: none;"' : ''); ?>>
                            <?php
